      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 text-black">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-4">
              When you create an account with Life Stacks, we collect information such as your name,
              email address, and any information you voluntarily provide. This information is used
              to provide and improve our services.
            </p>

            <h3 className="text-xl font-semibold mb-3">Usage Data</h3>
            <p className="mb-4">
              We collect information about how you use our platform, including your goals, progress
              tracking data, and interactions with our AI-powered features. This helps us provide
              personalized insights and improve our services.
            </p>
            ...
            <p className="mb-4">
              Payment processing for subscriptions is handled securely through PayPal. We do not
              store your payment information on our servers. PayPal's privacy policy applies to
            ...
            <p className="mb-4">
              ...
              contact us at Joseph@SuddenImpactLabs.com.
            </p>
            ...
            <p className="mb-4">
              Our platform may integrate with third-party services for enhanced functionality. These
            ...
            <p className="mb-8">
              <strong>Email:</strong> Joseph@SuddenImpactLabs.com
              <br />
