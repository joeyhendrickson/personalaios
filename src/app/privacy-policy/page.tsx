        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-gray-50 p-6 rounded-lg mb-8">
            ...
            <p className="text-sm text-gray-600">
              This Privacy Policy describes how Lifestacks.ai collects, uses, processes, and
              discloses information, including Google user data, when you use our Relationship
              Manager module and other Life Stacks applications.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-700">
                  The Life Stacks platform helps users organize their personal productivity through
                  various modules including:
                </p>
                <ul className="list-disc list-inside mt-2 space-y-1 text-gray-700">
                  <li>
                    <strong>Relationship Manager</strong>: Consolidates, organizes, and enhances
                    contact/relationship-related data and optionally links relevant media (e.g.
                  ...
                  <li>
                    <strong>Analytics Dashboard</strong>: Provides insights into productivity and
                    goal achievement
                  </li>
                  <li>
                    <strong>Business Hacks</strong>: Various productivity and business management
                    tools
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  To support media integration in our Relationship Manager, we allow you to grant
                  the App permission to access your Google Photos via OAuth 2.0. We adhere to
                  Google's OAuth 2.0 policies, Google API Services User Data Policy, and Google
                  Photos API terms.
                </p>
              </div>
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">
                  Minimal access & transparency
                </h3>
                <p className="text-gray-700">
                  We request only the minimal scopes necessary (e.g. reading photos from your Google
                  Photos library) and clearly disclose how we use any data obtained.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  If our data practices change (e.g. new scopes or usage), we will update this
                  policy and, where required, re-prompt you to consent before using new Google data.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                  ...
                  <li>
                    ...
                    relationships, habits, goals, projects, tasks, and any other data you enter into
                    our applications.
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                  <li>
                    <strong>Google Photos read access</strong>. We may list, read, and retrieve
                    media items from your Google Photos library (within the scopes you authorize).
                  </li>
                  <li>
                ...
                <p className="text-gray-700 mt-2">
                  We do not access or retrieve data outside the scopes you explicitly grant. We do
                  not access unrelated Google account data (e.g. Gmail messages, Drive files beyond
                  the photos scope) unless separately authorized.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700">
                  ...
                  <li>
                    Cookies and similar tracking technologies (for authentication, analytics,
                    sessions).
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-700">
                  We store data on secure servers (Supabase), encrypted at rest and in transit
                  (TLS). Access is limited to authorized systems and personnel.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  the service (and to comply with legal obligations). If you delete your account or
                  revoke Google access, we will delete or anonymize associated Google-linked data
                  within a reasonable period (e.g. 30–90 days).
                </p>
              </div>
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-2">Deletion</h3>
                <p className="text-gray-700">
                  You may request the deletion of your account or specific data. Upon deletion, we
                  will remove personal data and references to linked Google media (unless required
                  to retain for legal reasons). Backup copies may persist for limited periods but
                  will be purged.
                </p>
              </div>
            </div>
