...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      overallStrategy:
        'Based on AI analysis, focus on high-priority goals first. Break down complex goals into smaller tasks and tackle high-impact tasks during your peak energy hours. Consider dependencies between tasks and allocate time blocks for deep work.',
      aiAnalysis: {
