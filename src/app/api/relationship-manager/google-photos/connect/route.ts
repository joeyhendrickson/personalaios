  ...
  try {
    ...
    if (!clientId) {
      ...
      return NextResponse.json({ 
        ...
        message: 'Google Photos integration requires OAuth client credentials. This is a one-time setup for the application.',
        instructions: {
          ...
          step5: 'Add redirect URI: http://localhost:3000/api/relationship-manager/google-photos/callback',
