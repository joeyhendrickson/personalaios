...
const translations = {
  en: {
    ...
    'nav.tasks': 'Today',
    'nav.advisors': 'Life Talk',
    'nav.insights': 'Insights',
    'nav.connections': 'Relationships',
    'nav.settings': 'Profile',
    'nav.profile': 'Profile',
    'nav.signOut': 'Sign Out',
    'shell.goodMorning': 'Good morning, {name}',
    'shell.goodAfternoon': 'Good afternoon, {name}',
    'shell.goodEvening': 'Good evening, {name}',
    ...
    'glance.upcoming': 'Upcoming',
    'glance.topFocus': 'Top Focus',
    'glance.aiInsight': 'AI Insight',
    'glance.tasksLeft': '{count} tasks left',
    'glance.noTasks': 'No open tasks yet.',
    'glance.addTasks': 'Add tasks →',
    'glance.noHealth': 'Connect Fitness Tracker to see sleep, steps, and readiness.',
    'glance.openFitness': 'Open Fitness Tracker →',
    'glance.noFinance': 'Connect Budget Master to see net worth, cash, and investments.',
    'glance.openBudget': 'Open Budget Master →',
    'glance.noUpcoming': 'No upcoming dates yet.',
    'glance.viewCalendar': 'View calendar →',
    'glance.nextStep': 'Next step',
    'glance.keepGoing': 'Keep going — you are making progress.',
    'glance.noFocus': 'Set a goal or project to track your top focus.',
    'glance.addGoal': 'Add a goal →',
    ...
    'home.subtitle': 'Your goals, habits, and Stacks — stacked.',
    ...
    'modules.loading': 'Loading Stacks...',
    'modules.activeSection': 'Active Stacks',
    'modules.activeSectionHint': "Stacks you're currently using",
    'modules.availableSection': 'Available Stacks',
    'modules.availableSectionHint':
      'Install new Stacks as tools to help you complete your projects and reach your goals.',
    'modules.searchResults': 'Search results',
    'modules.searchResultsHint': 'Most relevant Stacks first',
    'modules.open': 'Open',
    ...
    'modules.noResults': 'No Stacks found',
    'modules.noResultsHint': 'Try adjusting your search or filter criteria',
    'modules.noSearchResultsHint':
      "Try different keywords — search looks across every Stack and what it's for.",
    ...
    'report.coverIncluded': 'Custom GPT Image cover included in PDF',
    'report.swotIncluded': 'SWOT included ({strengths} strengths, {opportunities} opportunities)',
    'report.modulesHighlighted': '{count} Stack highlighted',
    'report.modulesHighlightedPlural': '{count} Stacks highlighted',
  ...
  es: {
    ...
    'nav.connections': 'Relaciones',
    'nav.settings': 'Perfil',
    'nav.profile': 'Perfil',
    'nav.signOut': 'Cerrar Sesión',
    'shell.goodMorning': 'Buenos días, {name}',
    'shell.goodAfternoon': 'Buenas tardes, {name}',
    'shell.goodEvening': 'Buenas noches, {name}',
    ...
    'glance.upcoming': 'Próximo',
    'glance.topFocus': 'Enfoque principal',
    'glance.aiInsight': 'Idea de IA',
    'glance.tasksLeft': '{count} tareas restantes',
    'glance.noTasks': 'Aún no hay tareas abiertas.',
    'glance.addTasks': 'Agregar tareas →',
    'glance.noHealth': 'Conecta Fitness Tracker para ver sueño, pasos y preparación.',
    'glance.openFitness': 'Abrir Fitness Tracker →',
    'glance.noFinance': 'Conecta Budget Master para ver patrimonio, efectivo e inversiones.',
    'glance.openBudget': 'Abrir Budget Master →',
    'glance.noUpcoming': 'Aún no hay fechas próximas.',
    'glance.viewCalendar': 'Ver calendario →',
    'glance.nextStep': 'Siguiente paso',
    'glance.keepGoing': 'Sigue adelante — estás progresando.',
    'glance.noFocus': 'Crea una meta o proyecto para ver tu enfoque principal.',
    'glance.addGoal': 'Agregar una meta →',
    ...
    'home.subtitle': 'Tus objetivos, hábitos y Stacks — organizados.',
    ...
    'modules.searchPlaceholder': 'Buscar Stacks...',
    ...
    'modules.loading': 'Cargando Stacks...',
    'modules.activeSection': 'Stacks activos',
    'modules.activeSectionHint': 'Stacks que estás usando actualmente',
    'modules.availableSection': 'Stacks disponibles',
    'modules.availableSectionHint':
      'Instala nuevos Stacks como herramientas para completar tus proyectos y alcanzar tus metas.',
    'modules.searchResults': 'Resultados de búsqueda',
    'modules.searchResultsHint': 'Los Stacks más relevantes primero',
    'modules.open': 'Abrir',
    ...
    'modules.noResults': 'No se encontraron Stacks',
    'modules.noResultsHint': 'Prueba ajustar tu búsqueda o criterios de filtro',
    'modules.noSearchResultsHint':
      'Prueba otras palabras clave — la búsqueda abarca todos los Stacks y para qué sirven.',
    ...
    'report.coverIncluded': 'Portada personalizada GPT Image incluida en el PDF',
    'report.swotIncluded': 'FODA incluido ({strengths} fortalezas, {opportunities} oportunidades)',
    'report.modulesHighlighted': '{count} Stack destacado',
    'report.modulesHighlightedPlural': '{count} Stacks destacados',
