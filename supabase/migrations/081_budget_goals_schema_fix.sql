...
UPDATE budget_goals SET title = name WHERE title IS NULL AND name IS NOT NULL;
UPDATE budget_goals SET target_value = target_amount WHERE target_value IS NULL AND target_amount IS NOT NULL;
