-- Create sign-in streak trophies system
...
-- Insert sign-in streak trophies with incremental requirements
INSERT INTO signin_streak_trophies (name, description, streak_days_required, essence_description, reflection_message, icon_name, color, background_gradient, sound_cue) VALUES
